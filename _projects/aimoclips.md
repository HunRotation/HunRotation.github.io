...
{% assign v_gt_r = v_gt_score_norm | times: v_r_diff | plus: 119 | round %}
{% assign v_gt_g = v_gt_score_norm | times: v_g_diff | plus: 119 | round %}
{% assign v_gt_b = v_gt_score_norm | times: v_b_diff | plus: 119 | round %}
...
{% assign v_g_diff = 238 | minus: 119.0 %} 
{% assign v_b_diff = 0 | minus: 119.0 %}
{% assign v_rated_r = v_rated_score_norm | times: v_r_diff | plus: 119 | round %}
{% assign v_rated_g = v_rated_score_norm | times: v_g_diff | plus: 119 | round %}
{% assign v_rated_b = v_rated_score_norm | times: v_b_diff | plus: 119 | round %}
...
{% assign a_gt_r = a_gt_score_norm | times: a_r_diff | plus: 119 | round %}
{% assign a_gt_g = a_gt_score_norm | times: a_g_diff | plus: 119 | round %}
{% assign a_gt_b = a_gt_score_norm | times: a_b_diff | plus: 238 | round %}
...
{% assign a_g_diff = 119 | minus: 119.0 %}
{% assign a_b_diff = 119 | minus: 238.0 %}
{% assign a_rated_r = a_rated_score_norm | times: a_r_diff | plus: 119 | round %}
{% assign a_rated_g = a_rated_score_norm | times: a_g_diff | plus: 119 | round %}
{% assign a_rated_b = a_rated_score_norm | times: a_b_diff | plus: 238 | round %}
