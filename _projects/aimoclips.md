...
{% assign emotion = sample.emotion | strip %}
{% assign gt_scores = site.data.gt_scores[emotion] %}
<tr>
...
{% assign v_r_diff = 0 | minus: 119.0 %}
{% assign v_g_diff = 238 | minus: 119.0 %}
{% assign v_b_diff = 0 | minus: 119.0 %}
{% assign v_gt_r = 119 | plus: v_gt_score_norm | times: v_r_diff | round %}
{% assign v_gt_g = 119 | plus: v_gt_score_norm | times: v_g_diff | round %}
{% assign v_gt_b = 119 | plus: v_gt_score_norm | times: v_b_diff | round %}
...
{% assign v_g_diff = 238 | minus: 119.0 %} 
{% assign v_b_diff = 0 | minus: 119.0 %}
{% assign v_rated_r = 119 | plus: v_rated_score_norm | times: v_r_diff | round %}
{% assign v_rated_g = 119 | plus: v_rated_score_norm | times: v_g_diff | round %}
{% assign v_rated_b = 119 | plus: v_rated_score_norm | times: v_b_diff | round %}
...
{% assign a_r_diff = 238 | minus: 119.0 %}
{% assign a_g_diff = 119 | minus: 119.0 %}
{% assign a_b_diff = 119 | minus: 238.0 %}
{% assign a_gt_r = 119 | plus: a_gt_score_norm | times: a_r_diff | round %}
{% assign a_gt_g = 119 | plus: a_gt_score_norm | times: a_g_diff | round %}
{% assign a_gt_b = 238 | plus: a_gt_score_norm | times: a_b_diff | round %}
...
{% assign a_g_diff = 119 | minus: 119.0 %}
{% assign a_b_diff = 119 | minus: 238.0 %}
{% assign a_rated_r = 119 | plus: a_rated_score_norm | times: a_r_diff | round %}
{% assign a_rated_g = 119 | plus: a_rated_score_norm | times: a_g_diff | round %}
{% assign a_rated_b = 238 | plus: a_rated_score_norm | times: a_b_diff | round %}
