...
{% assign a_r_diff = 238 | minus: 0.0 %}
{% assign a_g_diff = 0 | minus: 0.0 %}
{% assign a_b_diff = 0 | minus: 238.0 %}
{% assign a_gt_r = a_gt_score_norm | times: a_r_diff | plus: 0 | round %}
{% assign a_gt_g = a_gt_score_norm | times: a_g_diff | plus: 0 | round %}
...
{% assign a_g_diff = 0 | minus: 0.0 %}
{% assign a_b_diff = 0 | minus: 238.0 %}
{% assign a_rated_r = a_rated_score_norm | times: a_r_diff | plus: 0 | round %}
{% assign a_rated_g = a_rated_score_norm | times: a_g_diff | plus: 0 | round %}
